...
from services.sheets import send_reminders_to_inactive, state_sheet, clear_user_state
...
# 🔔 Фоновая задача: незавершённые заявки
...
# 🔔 Фоновая задача: неактивные участники
